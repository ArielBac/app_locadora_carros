            ...
            <div class="form-row">
              <div class="col mb-3">
                ...
                >
                  <input
                    ...
                    class="form-control"
                    id="inputIdMarca"
                    aria-describedby="inputIdHelpMarca"
                    placeholder="ID"
                    v-model="busca.id"
                  />
                </input-container-component>
              ...
              <div class="col mb-3">
                <input-container-component
                  titulo="Marca"
                  id="inputNomeMarca"
                  id-help="inputNomeHelpMarca"
                  texto-ajuda="Informe a marca (opcional)"
                >
                  <input
                    type="text"
                    class="form-control"
                    id="inputNomeMarca"
                    aria-describedby="inputNomeHelpMarca"
                    placeholder="Marca"
                    v-model="busca.nome"
                  />
                </input-container-component>
            ...
            <div class="row">
              ...
              <div class="col">
                <button
                  ...
                  class="btn btn-primary btn-sm float-right"
                  data-toggle="modal"
                  data-target="#modalAdicionarMarca"
                >
                  Adicionar
                </button>
              </div>
    ...
    <modal-component id="modalAdicionarMarca" titulo="Adicionar marca">
      ...
      <template v-slot:conteudo>
        <div class="form-group">
          ...
          >
            <input
              ...
              class="form-control"
              id="inputIdNovaMarca"
              aria-describedby="inputIdHelpNovaMarca"
              placeholder="Marca"
              v-model="nomeMarca"
            />
          </input-container-component>
        ...
        <div class="form-group">
          <input-container-component
            titulo="Imagem"
            id="inputIdImagemNovaMarca"
            id-help="inputIdHelpImagemNovaMarca"
          ...
          >
            <input
              ...
              id="inputIdImagemNovaMarca"
              aria-describedby="inputIdHelpImagemNovaMarca"
    ...
    <modal-component id="modalAtualizarMarca" titulo="Atualizar marca">
      ...
      <template v-slot:conteudo>
        <div class="form-group">
          <input-container-component
            titulo="Marca"
            id="inputIdAtualizarMarca"
            id-help="inputIdHelpAtualizarMarca"
            texto-ajuda="Informe a marca"
          >
            <input
              type="text"
              class="form-control"
              id="inputIdAtualizarMarca"
              aria-describedby="inputIdHelpAtualizarMarca"
              placeholder="Marca"
        ...
        <div class="form-group">
          <input-container-component
            titulo="Imagem"
            id="inputIdAtualizarImagemMarca"
            id-help="inputIdHelpAtualizarImagemMarca"
            texto-ajuda="Selecione uma imagem no formato PNG"
          >
            <input
              type="file"
              class="form-control-file"
              id="inputIdAtualizarImagemMarca"
              aria-describedby="inputIdHelpAtualizarImagemMarca"
              placeholder="Selecione uma imagem"
              @change="carregarImagem($event)"
            />
          </input-container-component>
      ...
      axios
        ...
        .then((response) => {
          ...
          this.$store.state.transacao.mensagem =
            "Resgistro de marca atualizado com sucesso";
